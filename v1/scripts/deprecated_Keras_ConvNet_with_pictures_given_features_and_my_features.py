...
def combined_model():
    ...
    x = Convolution2D(8, 5, 5, input_shape=(96, 96, 1), border_mode='same')(image_input)
    x = (Activation('relu'))(x)
    ...
    numerical = Dense(512 ,activation='relu')(numerical_input)
...
#     concatenated = tf.concat(,[x, numerical])
