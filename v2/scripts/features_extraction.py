...
#     for img_no in num:
#         return_list.append([img_no, preprocess(read_img(img_no))])
...
def extract_features(img,image_num=-1):
...
def plot_leaf_and_features(features):
    ...
    # plt.plot(coords_to_cols(features['shape_contour'])[0],coords_to_cols(features['shape_contour'])[1])
