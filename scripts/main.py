...
#     contour_input = Input(shape=(length_per_contour,2), name='contour')
    contour_input = Input(shape=(length_per_contour,4), name='contour')
    
#     contour = (Reshape((length_per_contour,2)))(contour_input)
    contour = (Reshape((length_per_contour,4)))(contour_input)
    ...
    # 特征合并
    concatenated = merge([x, numerical,conv1d, contour], mode='concat')
#     concatenated = merge([conv1d, contour], mode='concat')
